...
export function SiteHeader() {
  ...
  return (
    <header
      className="flex h-(--header-height) shrink-0 fixed top-0 bg-background z-20 right-0 left-0 lg:left-64 items-center gap-2 border-b group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
      <div className="flex w-full items-center py-[12px] gap-1 px-4 lg:gap-2 lg:px-6">
